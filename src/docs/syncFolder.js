...
function managedBlock(toolEntry) {
  const skillsDir = toolEntry ? toolEntry.skillsDir : '.agents/skills';
  return [
    MANAGED_OPEN,
    ...
    `Tool directories like \`${skillsDir}/\` are symlinks (gitignored, regenerated on sync).`,
    '',
...
const MANAGED_BLOCK = managedBlock(null);
...
module.exports = { writeInstruction, isManaged, MANAGED_OPEN, MANAGED_CLOSE, MANAGED_BLOCK, managedBlock };
